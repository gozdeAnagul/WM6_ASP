...
namespace Admin.BLL.Identity
{
    public static class MembershipTools
    {
        ...
        public static UserManager<User> NewUserMenager() => new UserManager<User>(NewUserStore());
        public static RoleStore<Role> NewRoleStore() => new RoleStore<Role>(_db ?? new MyContext());
        public static RoleManager<Role> NewRoleMenager() => new RoleManager<Role>(NewRoleStore());
    }
}
